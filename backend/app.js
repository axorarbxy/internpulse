...
app.get('/health',(req,res)=>res.json({status:'ok',service:'core-backend'}));
...
app.use((err,req,res,next)=>{console.error('Unhandled error:',err);res.status(err.status||500).json({message:err.message||'Internal server error'});});
module.exports=app;
